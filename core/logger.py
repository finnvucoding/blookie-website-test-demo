...
class LogConfig:
    ...
    @classmethod
    def get_logger(cls, name: str = "BlogTestAuto") -> logging.Logger:
        if cls._logger:
            return cls._logger
        ...
        # Lấy đường dẫn từ settings để đảm bảo chính xác
...
def get_logger(name: str = "BlogTestAuto") -> logging.Logger:
